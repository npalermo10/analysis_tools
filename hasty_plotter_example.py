...
plotter2 =analysis_tools.Hasty_plotter(data = lmr, trial_axis = 0, color_axis = 2, x_axis = 1, time_axis = 3, starting_fig_num = len(plotter1.figs) + len(plotter0.figs))
